...
# 7 "ECU_layer/7-segment/ecu_7_segment.c" 2
# 16 "ECU_layer/7-segment/ecu_7_segment.c"
Std_ReturnType _7_segment_initialize(const _7_SEGMENT *segment)
{
    ...
    {
        gpio_pin_initialize(&(segment->segment_pins[0]));
        gpio_pin_initialize(&(segment->segment_pins[1]));
        gpio_pin_initialize(&(segment->segment_pins[2]));
        gpio_pin_initialize(&(segment->segment_pins[3]));
    }
    return ret;
}
