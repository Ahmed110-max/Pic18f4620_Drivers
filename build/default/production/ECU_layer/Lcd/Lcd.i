...
# 1 "ECU_layer/Lcd/../../MCAL_layer/GPIO/../device_configration.h" 1
...
Std_ReturnType convert_short_to_string(uint16 value ,uint8 *string)
{
    ...
    else
    {
        memset(string,' ',5);
        string[5]='\0';
        sprintf(dummy,"%i",value);
        while(dummy[counter]!='\0')
        {
            string[counter]=dummy[counter];
            counter++;
        }
    }
    return RET;
