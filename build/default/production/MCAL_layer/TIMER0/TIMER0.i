...
# 1 "MCAL_layer/TIMER0/../GPIO/../device_configration.h" 1
# 12 "MCAL_layer/TIMER0/../GPIO/hal_gpio.h" 2
# 30 "MCAL_layer/TIMER0/../GPIO/hal_gpio.h"
typedef enum
{
    low =0,
    high
...
# 1 "MCAL_layer/TIMER0/../interrupt/mcal_interrupt_configration.h" 1
# 11 "MCAL_layer/TIMER0/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h"
# 1 "MCAL_layer/TIMER0/../interrupt/../ADC/../../MCAL_layer/interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h" 2
# 71 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h"
typedef enum
{
    Adc_channel_AN0,
    Adc_channel_AN1,
...
# 96 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h"
typedef enum
{
    ADC_0_TAD,
    ADC_2_TAD,
...
# 115 "MCAL_layer/TIMER0/../interrupt/../ADC/ADC.h"
typedef enum{
...
# 12 "MCAL_layer/TIMER0/../interrupt/../ADC/../../MCAL_layer/interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER0/TIMER0.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../ADC/../../MCAL_layer/interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER1/TIMER1.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER1/TIMER1.h"
# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER1/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER1/TIMER1.h" 2
# 59 "MCAL_layer/TIMER0/../interrupt/../TIMER1/TIMER1.h"
typedef enum
{
...
# 14 "MCAL_layer/TIMER0/../interrupt/../TIMER1/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER2/TIMER2.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER2/TIMER2.h"
# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER2/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER2/TIMER2.h" 2
# 57 "MCAL_layer/TIMER0/../interrupt/../TIMER2/TIMER2.h"
typedef enum
{
...
# 15 "MCAL_layer/TIMER0/../interrupt/../TIMER2/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER3/TIMER3.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER3/TIMER3.h"
# 1 "MCAL_layer/TIMER0/../interrupt/../TIMER3/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER3/TIMER3.h" 2
# 50 "MCAL_layer/TIMER0/../interrupt/../TIMER3/TIMER3.h"
typedef enum
{
...
# 16 "MCAL_layer/TIMER0/../interrupt/../TIMER3/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER0/../interrupt/../../CCP.h" 1
# 14 "MCAL_layer/TIMER0/../interrupt/../../CCP.h"
# 1 "./MCAL_layer/interrupt/mcal_internal_interrupt.h" 1
# 14 "MCAL_layer/TIMER0/../interrupt/../../CCP.h" 2
# 76 "MCAL_layer/TIMER0/../interrupt/../../CCP.h"
typedef enum{
...
# 163 "MCAL_layer/TIMER0/../interrupt/../../CCP.h"
void CCP1_ISR(void);
...
# 13 "MCAL_layer/TIMER0/../interrupt/../TIMER0/TIMER0.h" 2
# 44 "MCAL_layer/TIMER0/../interrupt/../TIMER0/TIMER0.h"
typedef enum
{
...
# 6 "MCAL_layer/TIMER0/TIMER0.c" 2

static __attribute__((inline)) Std_ReturnType TIMER0_Set_Prescaler(const TIMER0 *my_TIMER0);
static __attribute__((inline)) Std_ReturnType TIMER0_Mode_Select(const TIMER0 *my_TIMER0);
static __attribute__((inline)) Std_ReturnType TIMER0_REGISTER_SIZE_Select(const TIMER0 *my_TIMER0);

static uint16 timer0_preload = 0;

volatile static Std_ReturnType (*TIMER0_INTERRUPT_HANDLER_CALL_BACK)(void) = ((void*)0);
...
Std_ReturnType TIMER0_READ_VALUE(const TIMER0 *my_TIMER0,uint16 *value)
{
    Std_ReturnType RET = (Std_ReturnType)0x01;
        uint8 timer0l = TMR0L;
        uint8 timer0h = TMR0H;
    if(((void*)0)==my_TIMER0 || ((void*)0)==value)
    {
       RET = (Std_ReturnType)0x00;
    }
    else
...
static __attribute__((inline)) Std_ReturnType TIMER0_Mode_Select(const TIMER0 *my_TIMER0)
{
    ...
    {
        if(my_TIMER0->Timer0_MODE==1)
        {
            T0CONbits.T0CS = 0;
        }
        else if(my_TIMER0->Timer0_MODE==0)
        {
            T0CONbits.T0CS = 1;
            if(my_TIMER0->Timer0_counter_Edge==1)
            {
                T0CONbits.T0SE = 0;
            }
            else if(my_TIMER0->Timer0_counter_Edge==0)
            {
                T0CONbits.T0SE = 1;
            }
        }
...
static __attribute__((inline)) Std_ReturnType TIMER0_REGISTER_SIZE_Select(const TIMER0 *my_TIMER0)
{
    ...
    {
        if(my_TIMER0->Timer0_REGISTER_SIZE==1)
        {
            T0CONbits.T08BIT = 1;
        }
        else if(my_TIMER0->Timer0_REGISTER_SIZE==0)
        {
            T0CONbits.T08BIT = 0;
        }
    }
