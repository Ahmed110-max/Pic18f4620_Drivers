...
# 11 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 1
# 11 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h"
...
# 11 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 2
...
# 11 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/TIMER3/../GPIO/../device_configration.h" 1
# 12 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h" 2
# 30 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h"
typedef enum
{
    low =0,
    high
...
# 1 "MCAL_layer/TIMER3/../interrupt/mcal_interrupt_configration.h" 1
# 11 "MCAL_layer/TIMER3/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h"
# 1 "MCAL_layer/TIMER3/../interrupt/../ADC/../../MCAL_layer/interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h" 2
# 71 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h"
typedef enum
{
    Adc_channel_AN0,
    Adc_channel_AN1,
...
# 96 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h"
typedef enum
{
    ADC_0_TAD,
    ADC_2_TAD,
...
# 115 "MCAL_layer/TIMER3/../interrupt/../ADC/ADC.h"
typedef enum{
...
# 12 "MCAL_layer/TIMER3/../interrupt/../ADC/../../MCAL_layer/interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER0/TIMER0.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER0/TIMER0.h"
# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER0/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER0/TIMER0.h" 2
# 44 "MCAL_layer/TIMER3/../interrupt/../TIMER0/TIMER0.h"
typedef enum
{
...
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER0/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER1/TIMER1.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER1/TIMER1.h"
# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER1/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER1/TIMER1.h" 2
# 59 "MCAL_layer/TIMER3/../interrupt/../TIMER1/TIMER1.h"
typedef enum
{
...
# 14 "MCAL_layer/TIMER3/../interrupt/../TIMER1/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER2/TIMER2.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER2/TIMER2.h"
# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER2/../interrupt/mcal_internal_interrupt.h" 1
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER2/TIMER2.h" 2
# 57 "MCAL_layer/TIMER3/../interrupt/../TIMER2/TIMER2.h"
typedef enum
{
...
# 15 "MCAL_layer/TIMER3/../interrupt/../TIMER2/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../TIMER3/TIMER3.h" 1
# 16 "MCAL_layer/TIMER3/../interrupt/../TIMER2/../interrupt/mcal_internal_interrupt.h" 2

# 1 "MCAL_layer/TIMER3/../interrupt/../../CCP.h" 1
# 14 "MCAL_layer/TIMER3/../interrupt/../../CCP.h"
# 1 "./MCAL_layer/interrupt/mcal_internal_interrupt.h" 1
# 14 "MCAL_layer/TIMER3/../interrupt/../../CCP.h" 2
# 76 "MCAL_layer/TIMER3/../interrupt/../../CCP.h"
typedef enum{
...
# 163 "MCAL_layer/TIMER3/../interrupt/../../CCP.h"
void CCP1_ISR(void);
...
# 13 "MCAL_layer/TIMER3/../interrupt/../TIMER3/TIMER3.h" 2
# 50 "MCAL_layer/TIMER3/../interrupt/../TIMER3/TIMER3.h"
typedef enum
{
...
static __attribute__((inline)) Std_ReturnType TIMER3_Set_Prescaler(const TIMER3 *my_TIMER3);
static __attribute__((inline)) Std_ReturnType TIMER3_Mode_Select(const TIMER3 *my_TIMER3);
static __attribute__((inline)) Std_ReturnType TIMER3_REGISTER_SIZE_Select(const TIMER3 *my_TIMER3);
static uint16 timer3_preload = 0;

volatile static Std_ReturnType (*TIMER3_INTERRUPT_HANDLER_CALL_BACK)(void) = ((void*)0);
...
Std_ReturnType TIMER3_READ_VALUE(const TIMER3 *my_TIMER3,uint16 *value)
{
    Std_ReturnType RET = (Std_ReturnType)0x01;
        uint8 timer3l = TMR3L;
        uint8 timer3h = TMR3H;
    if(((void*)0)==my_TIMER3 || ((void*)0)==value)
    {
       RET = (Std_ReturnType)0x00;
    }
    else
...
static __attribute__((inline)) Std_ReturnType TIMER3_Set_Prescaler(const TIMER3 *my_TIMER3)
{
    ...
    else
    {
            ...
            T3CONbits.T3CKPS = my_TIMER3->PRE_SCALER_VALUE;
...
static __attribute__((inline)) Std_ReturnType TIMER3_Mode_Select(const TIMER3 *my_TIMER3)
{
    ...
    {
        if(my_TIMER3->Timer3_MODE==0)
        {
            T3CONbits.TMR3CS = 0;
        }
        else if(my_TIMER3->Timer3_MODE==1)
        {
            T3CONbits.TMR3CS = 1;
        }
}
...
static __attribute__((inline)) Std_ReturnType TIMER3_REGISTER_SIZE_Select(const TIMER3 *my_TIMER3)
{
    ...
    {
        if(my_TIMER3->Timer3_REGISTER_SIZE==0)
        {
            T3CONbits.RD16 = 0;
        }
        else if(my_TIMER3->Timer3_REGISTER_SIZE==1)
        {
            T3CONbits.RD16 = 1;
        }
    }
